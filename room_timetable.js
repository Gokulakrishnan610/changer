...
//                 case 'large': return cap > 80 && cap <= 140;
//                 default: return true;
//             }
//         });
//     }
...
function processRoomData() {
    ...
    allData.forEach(session => {
        ...
        if (!roomData[roomKey]) {
            // Special handling for KSL02 room capacity
            let roomCapacity = session.capacity || 'N/A';
            if (session.room_number === 'KSL02') {
                roomCapacity = 140;
                console.log('✅ Setting KSL02 capacity to 140');
            }
